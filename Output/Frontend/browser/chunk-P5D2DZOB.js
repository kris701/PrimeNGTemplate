...
var LayoutService = class _LayoutService {
  ...
  constructor() {
    ...
    if (theme) {
      this._config = JSON.parse(theme);
      this.layoutConfig = signal(this._config);
    }
    effect(() => {
...
function AppConfigurator_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(5, _c0, (primaryColor_r2 == null ? null : primaryColor_r2.name) === "primengtemplate" ? "var(--p-primengtemplate-500)" : primaryColor_r2 == null ? null : primaryColor_r2.palette == null ? null : primaryColor_r2.palette["500"]));
    \u0275\u0275propertyInterpolate("pTooltip", primaryColor_r2 == null ? null : primaryColor_r2.name);
    \u0275\u0275property("title", primaryColor_r2.name)("ngClass", \u0275\u0275pureFunction1(7, _c1, primaryColor_r2.name === ctx_r2.selectedPrimaryColor()));
  }
}
function AppConfigurator_For_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(5, _c0, (surface_r5 == null ? null : surface_r5.name) === "primengtemplate" ? "var(--p-primengtemplate-500)" : surface_r5 == null ? null : surface_r5.palette == null ? null : surface_r5.palette["500"]));
    \u0275\u0275propertyInterpolate("pTooltip", surface_r5 == null ? null : surface_r5.name);
    \u0275\u0275property("title", surface_r5.name)("ngClass", \u0275\u0275pureFunction1(7, _c1, ctx_r2.selectedSurfaceColor() ? ctx_r2.selectedSurfaceColor() === surface_r5.name : ctx_r2.layoutService.layoutConfig().darkTheme ? surface_r5.name === "zinc" : surface_r5.name === "slate"));
  }
}
...
var AppConfigurator = class _AppConfigurator {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppConfigurator, selectors: [["app-configurator"]], hostAttrs: [1, "hidden", "absolute", "top-[3.25rem]", "right-0", "w-72", "p-4", "card", "border", "border-surface", "rounded-border", "origin-top", "shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]"], decls: 18, vars: 4, consts: [[1, "flex", "flex-col", "gap-4"], [1, "text-sm", "text-muted-color", "font-semibold"], [1, "pt-2", "flex", "gap-2", "flex-wrap", "justify-start"], ["type", "button", 1, "border-none", "w-5", "h-5", "rounded-full", "p-0", "cursor-pointer", "outline-none", "outline-offset-1", 3, "title", "ngClass", "pTooltip", "style"], [1, "flex", "flex-col", "gap-2"], ["size", "small", 3, "ngModelChange", "options", "ngModel", "allowEmpty"], ["class", "flex flex-col gap-2", 4, "ngIf"], ["type", "button", 1, "border-none", "w-5", "h-5", "rounded-full", "p-0", "cursor-pointer", "outline-none", "outline-offset-1", 3, "click", "title", "ngClass", "pTooltip"], ["size", "small", 3, "ngModelChange", "ngModel", "options", "allowEmpty"]], template: function AppConfigurator_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div")(2, "span", 1);
      \u0275\u0275text(3, "Primary");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 2);
      \u0275\u0275repeaterCreate(5, AppConfigurator_For_6_Template, 1, 9, "button", 3, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div")(8, "span", 1);
      \u0275\u0275text(9, "Surface");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "div", 2);
      \u0275\u0275repeaterCreate(11, AppConfigurator_For_12_Template, 1, 9, "button", 3, _forTrack0);
      \u0275\u0275elementEnd()();
  ...
  }, dependencies: [CommonModule, NgClass, NgIf, FormsModule, NgControlStatus, NgModel, SelectButtonModule, SelectButton, TooltipModule, Tooltip], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppConfigurator, { className: "AppConfigurator", filePath: "src/app/layout/component/app.configurator.ts", lineNumber: 96 });
})();
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-P5D2DZOB.js.map
